...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="Exemplo de Uso: py runner.py meu_codigo.txt"
    )
    ...
    # Grupo de ações para controlar o que fazer
    ...
    try:
        ...
        # Ação: --compile-only
            ...
            print("--- Código Intermediário (RPN) ---")
            for line in rpn:
                print(f" {line}")
        ...
        # Captura os erros sintátiicos/semânticos lançados pelo compilador
